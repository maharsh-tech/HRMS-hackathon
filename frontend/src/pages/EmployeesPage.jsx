...
const styles = {
    ...
    addBtn: { background: '#3b82f6', border: 'none', color: '#fff', padding: '0.6rem 1.25rem', borderRadius: 6, cursor: 'pointer', fontSize: '0.85rem', fontWeight: 500 },
    searchContainer: { display: 'flex', gap: '0.75rem', marginBottom: '1.25rem' },
    searchInput: { flex: 1, background: '#141414', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 6, padding: '0.6rem 1rem', color: '#fff', fontSize: '0.85rem' },
    refreshBtn: { background: '#1a1a1a', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', padding: '0.6rem 1rem', borderRadius: 6, cursor: 'pointer', fontSize: '0.8rem' },
    ...
    avatar: { width: 32, height: 32, background: '#3b82f6', borderRadius: 6, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', fontWeight: 600 },
    ...
    editBtn: { background: 'transparent', border: '1px solid rgba(255,255,255,0.2)', color: '#fff', padding: '0.4rem 0.75rem', borderRadius: 4, cursor: 'pointer', fontSize: '0.75rem' },
};
