...
const styles = {
    ...
    headerTitle: { fontSize: '1.75rem', fontWeight: 600, margin: '0.5rem 0 0.25rem' },
    headerSubtitle: { color: 'rgba(255,255,255,0.5)', margin: 0 },
    backLink: { color: '#3b82f6', textDecoration: 'none', fontSize: '0.85rem' },
    saveBtn: { background: '#3b82f6', border: 'none', color: '#fff', padding: '0.6rem 1.25rem', borderRadius: 6, cursor: 'pointer', fontSize: '0.85rem', fontWeight: 500 },
    message: { padding: '0.75rem 1rem', borderRadius: 6, marginBottom: '1.25rem', border: '1px solid' },
    tabs: { display: 'flex', gap: '0.5rem', marginBottom: '1.25rem', borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: '1rem' },
    tab: { background: '#141414', border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.6)', padding: '0.6rem 1rem', borderRadius: 6, cursor: 'pointer', fontSize: '0.85rem', transition: 'all 0.2s ease' },
    tabActive: { background: 'rgba(59, 130, 246, 0.15)', borderColor: '#3b82f6', color: '#fff' },
    tabContent: { background: '#111', borderRadius: 12, padding: '1.25rem', border: '1px solid rgba(255,255,255,0.08)' },
    ...
    error: { textAlign: 'center', padding: '2rem', color: '#ef4444' },
    accessDenied: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#0a0a0a', color: '#fff', textAlign: 'center' },
};
